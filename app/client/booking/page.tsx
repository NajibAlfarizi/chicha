              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 md:p-4">
                  ...
                  <ul className="text-sm space-y-1">
                    ...
                    <li>• Admin kami akan menugaskan teknisi terbaik untuk perbaikan Anda</li>
                    <li>• Anda akan mendapat notifikasi nama teknisi yang ditugaskan</li>
                    <li>• Update progress perbaikan akan dikirim secara realtime</li>
